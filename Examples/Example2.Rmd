---
title: "A Second Example of Polynomial Regression"
...
* $Z_i$ - Obs RQ of couple $i$: $1-9$
* $Y_i$ - Wife ($i$)'s Report of RI: } $1-6$
* $X_i$ - Husband ($i$)'s Report of RI: $1-6$
...
And the plot them using **principal_plot_surface**
```{r}
...
</center>![](https://plot.ly/~nulloa1/150.png)</center>
