...
print(xtable(t(Phillipsdf),caption = c("Five number summary of response variables($Z_1$ and $Z_2$) and explanotry variable $X$ and $Y$."), label = "tab:Phillipsdf"), sanitize.rownames.function = function(x) {x})
@
